...
class TodolistsControllerTest < ActionController::TestCase
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post :create, todolist: { date: @todolist.date, description: @todolist.description, title: @todolist.title }
    end
  ...
  test "should update todolist" do
    patch :update, id: @todolist, todolist: { date: @todolist.date, description: @todolist.description, title: @todolist.title }
    assert_redirected_to todolist_path(assigns(:todolist))
  end
